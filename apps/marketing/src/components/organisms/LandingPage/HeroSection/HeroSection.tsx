...
import PencilImage from '../../../../images/svgs/pencil.svg';
    ...
    return (
        <section className=" md:justify-evenly h-[80vh] max-h-[500px] ">
            <div className=" flex flex-col items-center mt-40 px-4 ">
                ...
                <div className="absolute bg-transparent border-solid border border-back w-full h-20"/> */}
                <div className=" bg-white w-[90%] lg:w-[105%] xl:w-[110%] mt-10  mb-16  h-14 md:h-20 shadow-xl hero-input-borders relative">
                    <div className="flex justify-between items-center mx-16 h-[inherit] relative">
                    ...
                    <PencilImage className="absolute h-16 max-w-[60px] md:h-24 w-[36px] md:w-[45px] lg:w-[60px] ml-auto -right-2 md:right-[-1rem] top-[-2rem] md:top-[-4rem] svg-shadow z-10" />
